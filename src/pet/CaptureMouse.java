    ...
    public static void upd(){
        ...
        if(currentTime-lastCaptureMove>captureMoveCap){
            ...
            if(pointer!=null){
                ...
                if(getPoseHistory().get(0).x>GLFW_Manager.getDefaultWindow().getSize().x&&getPoseHistory().get(0).y>GLFW_Manager.getDefaultWindow().getSize().y&&getPoseHistory().get(0).x<GLFW_Manager.getDefaultWindow().getPosition().x&&getPoseHistory().get(0).y<GLFW_Manager.getDefaultWindow().getPosition().y){
